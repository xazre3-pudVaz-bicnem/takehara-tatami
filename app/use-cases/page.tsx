...
export const metadata: Metadata = {
  title: '用途別の畳選び｜ペット・赤ちゃん・高齢者・賃貸・旅館など',
  description: '用途・ライフスタイル別の畳選びガイド。ペット家庭・赤ちゃん・高齢者・賃貸・旅館・新築・リフォームなど、それぞれの用途に最適な素材と施工をご提案します。',
  openGraph: {
    title: '用途別の畳選び｜(有)竹原タタミ店',
    description: '用途・ライフスタイル別の畳選びガイド。ペット・赤ちゃん・高齢者・賃貸・旅館など各シーンに最適な提案。',
  },
}
...
const jsonLd = {
  ...
  url: 'https://takehara-tatami.com/use-cases',
  breadcrumb: {
    '@type': 'BreadcrumbList',
    itemListElement: [
          ...
          <div className="max-w-5xl mx-auto px-6 sm:px-8">
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              {useCasesData.map((useCase) => (
                ...
                >
                  <div className="text-3xl flex-shrink-0 mt-0.5">{useCase.icon}</div>
