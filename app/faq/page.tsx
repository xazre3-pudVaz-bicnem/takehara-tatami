...
const faqs = [
  ...
  { cat: 'area', q: '鹿児島市以外も対応していますか？', a: '基本的には鹿児島市全域を対応エリアとしております。市外の場合は事前にご相談ください。距離・状況によって対応可否をお伝えします。' },
  { cat: 'area', q: '対応エリアはどこですか？', a: '鹿児島市全域に対応しています。東谷山・谷山・宇宿・中山・紫原・坂之上・和田・郡元・武岡・草牟田・吉野・小松原などが主な対応エリアです。' },
