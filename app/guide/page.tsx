...
export const metadata: Metadata = {
  title: '鹿児島の畳ガイド｜料金・お手入れ・交換時期・素材選びを解説',
  description: '鹿児島市の畳専門店・竹原タタミ店が解説する畳ガイド。表替えと新調の違い・裏返し・料金の目安・お手入れ方法・寿命・カビ対策・素材選びまで詳しく説明します。',
  keywords: ['鹿児島 畳 ガイド', '畳 お手入れ 鹿児島', '畳 交換時期', '畳 料金 目安', '鹿児島 畳 カビ対策', '畳 表替え 新調 違い'],
  openGraph: {
    title: '鹿児島の畳ガイド｜料金・お手入れ・交換時期・素材選び',
    description: '鹿児島市の畳専門店が解説する畳ガイド。料金・お手入れ・交換時期・素材選びまで。',
  },
}
