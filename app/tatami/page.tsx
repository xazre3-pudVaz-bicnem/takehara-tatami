...
const cycle = [
  ...
  },
  {
    ...
    price: '¥5,000〜 / 枚',
    priceDetails: [
      { label: '天然い草（下級品）', price: '5,000円〜' },
      { label: '和紙・樹脂表',       price: '12,000円〜' },
      { label: '国産高級い草',       price: '25,000円〜' },
    ],
  ...
  },
  {
    ...
    price: '¥15,000〜 / 枚',
    priceDetails: [
      { label: '天然い草（下級品）', price: '15,000円〜' },
      { label: '和紙・樹脂表',       price: '22,000円〜' },
      { label: '国産高級い草',       price: '35,000円〜' },
    ],
