...
const reasons = [
  ...
  },
  {
    ...
    body: '表替え・裏返し・新調・縁なし畳（目積）・和紙畳・樹脂畳まで。鹿児島市内のあらゆる畳のご要望にお応えします。',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: '和モダン空間にも対応',
    body: '縁なし畳（目積）・カラー和紙畳・樹脂畳など、現代的なインテリアに合うおしゃれな畳選びもご相談ください。',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    title: '施工実績10,000枚以上で安心',
    body: '累計10,000枚を超える施工実績から培われた技術と丁寧さ。豊富なビフォーアフター写真でイメージを確認しながら、安心してご依頼いただけます。',
  },
]
