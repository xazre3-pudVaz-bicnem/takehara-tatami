...
const inputCls =
  'w-full border border-tatami-100 bg-white rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-tatami-400 focus:ring-1 focus:ring-tatami-200 transition-colors placeholder:text-tatami-300 text-ink'
...
export default function Contact() {
  ...
  if (status === 'success') {
    return (
      <section id="contact" className="py-20 md:py-28 bg-[#EEF5E8] relative overflow-hidden">
        <div className="absolute inset-0 seigaiha" />
        <div className="relative z-10 max-w-xl mx-auto px-6 text-center">
          <motion.div
            className="bg-white border border-tatami-100 rounded-2xl p-12 shadow-md"
  ...
  return (
    <section id="contact" className="py-20 md:py-28 bg-[#EEF5E8] relative overflow-hidden">
      <div className="absolute inset-0 seigaiha" />
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-tatami-300/40 to-transparent" />

      <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-8">
        <SectionTitle en="CONTACT" ja="お問い合わせ" description="現地確認・お見積もりは無料です。まずはお気軽にご連絡ください。" />
        ...
        <div ref={ref} className="grid md:grid-cols-5 gap-8">
          ...
          >
            <div className="bg-white border border-tatami-100 rounded-2xl p-6 shadow-sm">
              <p className="text-tatami-400 text-[10px] tracking-[0.3em] font-sans mb-3">TEL（最優先）</p>
              <a
                href="tel:0992671577"
                className="text-ink font-bold text-2xl block hover:text-tatami-500 transition-colors mb-1 font-serif"
              >
                099-267-1577
              </a>
            ...
            <div className="bg-white border border-tatami-100 rounded-2xl p-6 shadow-sm">
              ...
              {[
                ...
                <div key={item} className="flex items-center gap-2 text-muted text-sm mb-2.5">
            ...
            <div className="bg-white border border-tatami-100 rounded-2xl p-5 shadow-sm">
          ...
          >
            <form
              ...
              className="bg-white border border-tatami-100 rounded-2xl p-7 md:p-9 shadow-md space-y-5"
            >
